...
namespace OpenAsMenu
{
    ...
    public partial class MainWindow : Window
    {
        ...
        {
            var aboutMessage = "=== Win11右键菜单切换功能 ===\n\n" +
                "此功能允许您在Win11的两种右键菜单样式之间切换：\n\n" +
                "🔹 Win11默认样式（一级菜单）\n" +
                "   - 显示简化的右键菜单\n" +
                "   - 需要点击\"显示更多选项\"查看完整菜单\n\n" +
                "🔹 Win10样式（完整二级菜单）\n" +
                ...
                "• 更改会立即生效\n\n" +
                "💡 原理：\n" +
                "通过修改注册表项 {86ca1aa0-34aa-4e8b-a509-50c905bae2a2} 来控制菜单显示方式。";

            MessageBox.Show(aboutMessage, "关于Win11菜单切换", MessageBoxButton.OK, MessageBoxImage.Information);
        }
